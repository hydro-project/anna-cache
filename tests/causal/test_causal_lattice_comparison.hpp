...
TEST_F(CausalCacheTest, CausalLatticeComparison) {
  MultiKeyCausalPayload<SetLattice<string>> ccp1;
  ccp1.vector_clock.insert("c1", 1);
  ccp1.vector_clock.insert("c2", 0);
  std::shared_ptr<MultiKeyCausalLattice<SetLattice<string>>> ccl1 =
      std::make_shared<MultiKeyCausalLattice<SetLattice<string>>>(ccp1);

  MultiKeyCausalPayload<SetLattice<string>> ccp2;
  ccp2.vector_clock.insert("c1", 0);
  ccp2.vector_clock.insert("c2", 1);
  std::shared_ptr<MultiKeyCausalLattice<SetLattice<string>>> ccl2 =
      std::make_shared<MultiKeyCausalLattice<SetLattice<string>>>(ccp2);
